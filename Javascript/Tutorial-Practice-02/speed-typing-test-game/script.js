...
const typingText = document.querySelector('#typing-text-id');
const inputField = document.querySelector('#input-field-id');
const tryAgainBtn = document.querySelector('#content-button');
const timeTag = document.querySelector('#time-left-tag');
...
function loadParagraph() {
	...
	paragraphs[ranIndex].split('').forEach((char) => {
		let span = `<span class="typing-text__span">${char}</span>`;
