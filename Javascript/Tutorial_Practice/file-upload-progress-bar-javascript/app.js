/* Upload File with Vanilla JavaScript and Loading Animation #+++>>> https://stackabuse.com/upload-file-with-vanilla-javascript-and-loading-animation/ */
...
function uploadFile(name) {
  ...
  xhrRequest.upload.addEventListener('progress', ({ loaded, total }) => {
    ...
    let progressMarkup = `<li class="row section__row">
        <i class="fas fa-file-alt section__icon"></i>
