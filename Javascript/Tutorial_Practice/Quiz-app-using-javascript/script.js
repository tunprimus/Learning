/* Modified from Quiz App using HTML, CSS and JavaScript (Source Code) – Coding Torque https://codingtorque.com/quiz-app-using-javascript/ */
...
function quizCreator() {
    ...
    for (let item of quizArray) {
        ...
        <button class="option-div" onclick="checker(this)">${item.options[3]}</button>
        `;
        quizContainer.appendChild(div);
    }
}

// Checker function to check if option is correct
