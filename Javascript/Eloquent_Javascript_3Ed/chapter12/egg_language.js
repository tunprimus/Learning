...
Objective: Build a programming language called Egg. It will be tiny, simple language—but one that is powerful enough to express any computation you can think of. It will allow simple abstraction based on functions. 
...
function parse(programme) {
     ...
     * gives us the programme’s data structure (syntax tree represented by a nested sequence
...
// We’ll use object prototype chains to represent nested scopes so that the programme can add bindings
