...
// Function to load the talks JSON file
function loadTalks() {
    let json = undefined;
    try {
...
// Extend the updated aspect of the prototype to handle writing to files
...
// Update to activate the loadTalks function when server starts
