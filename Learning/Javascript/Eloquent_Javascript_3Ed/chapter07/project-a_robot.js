...
// Using routes that the robot can transverse twice will be more efficient.
...
function goalOrientedRobot({place, parcels}, route) {
    // List of directions is empty
    if (route.length == 0) {
        console.log("... Decision: Robot decides on a new route.\n");
        // Checks first parcel from its list
        let parcel = parcels[0];
        // Plot route to pick up parcel, other plot route to deliver it
